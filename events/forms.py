...
class EventForm(forms.ModelForm):
    ...
    MUTED_COLOR_CHOICES = [
        ...
        # Dark — useful on light backgrounds
        ('#475569', 'Dark Slate'),
        ('#334155', 'Deep Slate'),
    ...
    class Meta:
        model = Event
        fields = ['title', 'event_date', 'location_name', 'address']
        widgets = {
    ...
    def save(self, commit=True):
        ...
        gallery_urls = list(theme.get('gallery_images', []))
        ...
        for gallery_file in uploaded_gallery_files:
            if gallery_file:
                ...
                if media_path not in gallery_urls:
                    gallery_urls.append(media_path)

        theme['gallery_images'] = gallery_urls
...
from django import forms
from .models import Guest  # Adjust based on your actual model name
